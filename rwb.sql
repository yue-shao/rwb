...
create table rwb_invitations (randomID VARCHAR(40) NOT NULL, email VARCHAR(256) NOT NULL, constraint NewEmail_ok CHECK (email LIKE '%@%'),referer VARCHAR(64) NOT NULL references rwb_users(name),permissions VARCHAR(256));
